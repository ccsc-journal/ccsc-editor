...
\title{Manuscript Formatting Instructions\footnote{\protect\input{copyright}}
}
...
The title should use title-casing and you can use this tool to double check:
\texttt{https://titlecaseconverter.com}
...
In this case, you can either divide the table into multiple parts, or use the
following code to put the table/figure sideways on its own page as shown in
Figure \ref{figure:big_table1}.
